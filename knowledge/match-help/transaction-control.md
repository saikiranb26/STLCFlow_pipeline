# Match Help Context - Transaction Control
...
This file covers the Match functional area **Transaction Control**. Key child pages include Transaction Control Screen. Use it with the regression-suite corpus in the parent knowledge folder when writing story-specific testcases.
...
### Transaction Control Screen

- TOC path: Match > Advanced Features > Understanding the Manage Dashboard > Transaction Control Screen
- Source: https://cadencyhelp.lower.trintech.com/edinburgh/content/match/managemenu/transactioncontrolscreen.htm
