# Match Help Context - Transaction criteria
...
This file covers the Match functional area **Transaction criteria**. Key child pages include Transaction criteria Screen. Use it with the regression-suite corpus in the parent knowledge folder when writing story-specific testcases.
...
- TOC path: Match > Advanced Features > About the Transactions Dashboard > Transaction criteria Screen
- Source: https://cadencyhelp.lower.trintech.com/edinburgh/content/match/configurationmenu/transactioncriteria/transactioncriteriascreen.htm
