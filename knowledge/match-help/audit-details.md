# Match Help Context - Audit Details
...
This file covers the Match functional area **Audit Details**. Key child pages include Audit Details Screen. Use it with the regression-suite corpus in the parent knowledge folder when writing story-specific testcases.
...
- TOC path: Match > Advanced Features > About the Audits Dashboard > Audit Details Screen
- Source: https://cadencyhelp.lower.trintech.com/edinburgh/content/match/auditmenu/auditdetailsscreen.htm
