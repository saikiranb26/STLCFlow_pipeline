# Match Help Context - Balance control
...
This file covers the Match functional area **Balance control**. Key child pages include Correcting Adjusted Balance Errors. Use it with the regression-suite corpus in the parent knowledge folder when writing story-specific testcases.
...
### Correcting Adjusted Balance Errors

- TOC path: Match > Advanced Features > Understanding the Manage Dashboard > Balance control Screen
- Source: https://cadencyhelp.lower.trintech.com/edinburgh/content/match/managemenu/balancecontrolscreen.htm
...
- Section cues: Balance control Screen; Related Topics
