...
This file covers the Match functional area **Overview**. Key child pages include About Match. Use it with the regression-suite corpus in the parent knowledge folder when writing story-specific testcases.
...
- TOC path: Match
- Source: https://cadencyhelp.lower.trintech.com/edinburgh/content/match/reference/match.htm
- Context: Functional coverage: verify the About Match behavior through navigation, field validation, save/cancel flow, grid state, and permissions.
