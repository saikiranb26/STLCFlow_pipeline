# Match Help Context - Viewing the Reconciliation History
...
This file covers the Match functional area **Viewing the Reconciliation History**. Key child pages include Viewing the Reconciliation History. Use it with the regression-suite corpus in the parent knowledge folder when writing story-specific testcases.
...
### Viewing the Reconciliation History

- TOC path: Match > Advanced Features > About the Archive Dashboard > Viewing the Reconciliation History
- Source: https://cadencyhelp.lower.trintech.com/edinburgh/content/match/archivemenu/reconciliationdetailsscreen.htm
...
- Section cues: Reconciliation details screen
