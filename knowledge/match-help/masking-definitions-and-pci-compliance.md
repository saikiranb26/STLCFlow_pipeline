# Match Help Context - Masking Definitions and PCI Compliance
...
This file covers the Match functional area **Masking Definitions and PCI Compliance**. Key child pages include Masking Definitions and PCI Compliance, Configure Masking Definitions Screen. Use it with the regression-suite corpus in the parent knowledge folder when writing story-specific testcases.
...
### Masking Definitions and PCI Compliance

- TOC path: Match > Advanced Features > About the Admin Dashboard > Masking Definitions and PCI Compliance
- Source: https://cadencyhelp.lower.trintech.com/edinburgh/content/match/reference/pci_compliance.htm
...
- Section cues: Masking Definitions - PCI Compliance

### Configure Masking Definitions Screen

- TOC path: Match > Advanced Features > About the Admin Dashboard > Masking Definitions and PCI Compliance > Configure Masking Definitions Screen
- Source: https://cadencyhelp.lower.trintech.com/edinburgh/content/match/admindashboard/maskingdefinitions/configure%20masking_definitions.htm
- Context: Dashboard/navigation coverage: verify entry points, available cards or links, default landing behavior, and role-based visibility.
- Context: Setup/maintenance coverage: verify add, edit, save, cancel, required fields, duplicate handling, and validation messages.
