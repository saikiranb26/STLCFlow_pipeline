# Match Help Context - Create batch|Edit batch
...
This file covers the Match functional area **Create batch|Edit batch**. Key child pages include Create batch|Edit batch Screen. Use it with the regression-suite corpus in the parent knowledge folder when writing story-specific testcases.
...
### Create batch|Edit batch Screen

- TOC path: Match > Advanced Features > Understanding the Manage Dashboard > Create batch|Edit batch Screen
- Source: https://cadencyhelp.lower.trintech.com/edinburgh/content/match/managemenu/create-edittransactioncontrolbatchscreen.htm
