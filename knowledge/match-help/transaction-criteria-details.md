# Match Help Context - Transaction criteria details
...
This file covers the Match functional area **Transaction criteria details**. Key child pages include Transaction criteria details Screen. Use it with the regression-suite corpus in the parent knowledge folder when writing story-specific testcases.
...
### Transaction criteria details Screen

- TOC path: Match > Advanced Features > About the Transactions Dashboard > Transaction criteria details Screen
- Source: https://cadencyhelp.lower.trintech.com/edinburgh/content/match/configurationmenu/transactioncriteria/transactioncriteriadetailsscreen.htm
