# Match Help Context - Transaction details
...
This file covers the Match functional area **Transaction details**. Key child pages include Transaction details Screen. Use it with the regression-suite corpus in the parent knowledge folder when writing story-specific testcases.
...
- TOC path: Match > Advanced Features > About the Transactions Dashboard > Transaction details Screen
- Source: https://cadencyhelp.lower.trintech.com/edinburgh/content/match/transactionsmenu/transactiondetailsscreen.htm
