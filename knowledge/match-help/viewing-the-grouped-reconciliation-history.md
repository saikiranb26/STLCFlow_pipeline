# Match Help Context - Viewing the Grouped Reconciliation History
...
This file covers the Match functional area **Viewing the Grouped Reconciliation History**. Key child pages include Viewing the Grouped Reconciliation History. Use it with the regression-suite corpus in the parent knowledge folder when writing story-specific testcases.

## QA Focus

- Cover navigation, default values, required fields, grid behavior, save/cancel flows, permissions, and audit/result evidence.

## Child Pages

### Viewing the Grouped Reconciliation History

- TOC path: Match > Advanced Features > About the Archive Dashboard > Viewing the Grouped Reconciliation History
- Source: https://cadencyhelp.lower.trintech.com/edinburgh/content/match/archivemenu/groupreconciliationdetailsscreen.htm
...
- Section cues: Group details Screen
